...
describe('Socket listener leak prevention', () => {
	...
	it('should handle SSR requests correctly with abort controller setup', async () => {
		// Verify that SSR routes still work correctly
